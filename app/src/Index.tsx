    ...
    <div className="min-h-screen flex flex-col font-sans overflow-x-hidden">
      ...
      <section id="home" className="relative pt-12 pb-24 lg:pt-20 lg:pb-32 bg-gradient-to-b from-[#F4F3F8] to-[#FAF9FC] overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            Discover Patient-Centered Health Consultation Services <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#7C3AED] to-indigo-600">Anything, Anytime</span>
          </motion.h1>
